...
<div class="modal-body py-1">
  @if ($promisedQty == $deliveryOrderQty || $promisedQty - $deliveryOrderQty <= 0 ) <div
    class="callout callout-info my-2">
    ...
    <div class="col-md-4 col-12">
      <div class="form-group">
        ...
        <select name="driver" id="driver"
          class="form-control border selectpicker @if($errors->has('driver')) is-invalid @endif" data-live-search="true"
    ...
    <div class="col-md-4 col-12">
      <div class="form-group">
        ...
        <select name="helper" id="helper"
          class="form-control border selectpicker @if($errors->has('helper')) is-invalid @endif" data-live-search="true"
          title="Pilih Helper">
