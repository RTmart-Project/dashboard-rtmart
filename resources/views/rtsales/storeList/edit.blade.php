...
@section('title', 'Dashboard - Edit Store')

@section('css-pages')
<link rel="stylesheet" href="{{ url('/') }}/plugins/bootstrap-select/bootstrap-select.min.css">
@endsection

@section('header-menu', 'Ubah Store '.$storeID)
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form id="edit-store" method="post" action="{{ route('rtsales.updateStore', ['storeID' => $storeID]) }}">
              @csrf
              <div class="row">
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="store_name" id="store_name" placeholder="Masukan Nama Store"
                      value="{{ old('store_name') ? old('store_name') : $store->StoreName }}" required autocomplete="off"
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="owner_name" id="owner_name" placeholder="Masukan Nama Pemilik"
                      value="{{ old('owner_name') ? old('owner_name') : $store->OwnerName }}" required autocomplete="off"
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="phone_number" id="phone_number" placeholder="Masukan No. HP"
                      value="{{ old('phone_number') ? old('phone_number') : $store->PhoneNumber }}" required autocomplete="off"
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="address" id="address" autocomplete="off"
                      placeholder="Masukan Alamat" value="{{ old('address') ? old('address') : $store->StoreAddress }}" required
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="latitude" id="latitude" autocomplete="off"
                      placeholder="Masukan Latitude" value="{{ old('latitude') ? old('latitude') : $store->Latitude }}" required
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="longitude" id="longitude" autocomplete="off"
                      placeholder="Masukan Longitude" value="{{ old('longitude') ? old('longitude') : $store->Longitude }}" required
                  ...
                  <div class="form-group">
                    ...
                    <select name="sales" id="sales" required data-live-search="true" title="Pilih Sales" 
                      ...
                      <option value="{{ $value->SalesCode }}"
                        {{ $store->SalesCode == $value->SalesCode ? 'selected' : '' }}>
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <select name="grade" id="grade" required title="Pilih Grade" 
                      ...
                      <option value="RETAIL" {{ ($store->Grade == "RETAIL") ? 'selected' : '' }}>RETAIL</option>
                      <option value="SO" {{ ($store->Grade == "SO") ? 'selected' : '' }}>SO</option>
                      <option value="WS" {{ ($store->Grade == "WS") ? 'selected' : '' }}>WS</option>
                    </select>
                    @if($errors->has('grade'))
                ...
                <div class="col-md-6 col-12">
                  <div class="form-group">
                    ...
                    <select name="store_type" id="store_type" required title="Pilih Store Type" 
                      ...
                      <option value="NEW" {{ ($store->StoreType == "NEW") ? 'selected' : '' }}>NEW</option>
                      <option value="EXISTING" {{ ($store->StoreType == "EXISTING") ? 'selected' : '' }}>EXISTING</option>
                    </select>
