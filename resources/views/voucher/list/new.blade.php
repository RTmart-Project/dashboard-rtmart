            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('voucher.list') }}" class="btn btn-sm btn-light">
                            <i class="fas fa-arrow-left"></i>
                            Kembali
                        </a>
                    </div>
                    <div class="card-body">
                        <form id="add-voucher" method="post" action="{{ route('voucher.insertList') }}"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="voucher_name" name="voucher_name" class="form-control
                                            ...
                                            placeholder="Masukkan Nama Voucher" value="{{ old('voucher_name') }}"
                                            required>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker border
                                            @if($errors->has('voucher_type')) is-invalid @endif" name="voucher_type"
                                            id="voucher_type" title="Pilih Jenis Voucher" required>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" id="percentage" name="percentage" class="form-control
                                                ...
                                                placeholder="Masukkan Persentase Voucher"
                                                value="{{ old('percentage') }}" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-percent"></i></span>
                                            </div>
                                            @if($errors->has('percentage'))
                                            <span class="error invalid-feedback">{{ $errors->first('percentage')
                                                }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" id="max_nominal" name="max_nominal" class="form-control
                                                ...
                                                placeholder="Masukkan Maksimum Nominal Voucher"
                                                value="{{ old('max_nominal') }}" required>
                                            @if($errors->has('max_nominal'))
                                            <span class="error invalid-feedback">{{ $errors->first('max_nominal')
                                                }}</span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker border 
                                            @if($errors->has('is_for')) is-invalid @endif" name="is_for" id="is_for"
                                            title="Pilih Voucher untuk siapa" required>
                                            <option value="Customer" {{ (old('is_for')=="Customer" ) ? 'selected' : ''
                                                }}>Customer</option>
                                            <option value="Merchant" {{ (old('is_for')=="Merchant" ) ? 'selected' : ''
                                                }}>Merchant</option>
                                            <option value="All" {{ (old('is_for')=="All" ) ? 'selected' : '' }}>Customer
                                                dan Merchant</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control
                                            @if($errors->has('start_date')) is-invalid @endif" name="start_date"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control
                                            @if($errors->has('end_date')) is-invalid @endif" name="end_date"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker border 
                                            ...
                                            name="check_power_merchant" id="check_power_merchant"
                                            title="Pilih apakah syarat harus power merchant" required>
                                            <option value="1" {{ (old('check_power_merchant')=="1" ) ? 'selected' : ''
                                                }}>Ya</option>
                                            <option value="0" {{ (old('check_power_merchant')=="0" ) ? 'selected' : ''
                                                }}>Tidak</option>
                                        </select>
                                        @if($errors->has('check_power_merchant'))
                                        <span class="error invalid-feedback">{{ $errors->first('check_power_merchant')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row border-bottom border-secondary">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control
                                            ...
                                            name="quota_per_user" id="quota_per_user"
                                            placeholder="Masukkan Kuota per User" value="{{ old('quota_per_user') }}"
                                            required>
                                        @if($errors->has('quota_per_user'))
                                        <span class="error invalid-feedback">{{ $errors->first('quota_per_user')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control
                                            @if($errors->has('max_quota')) is-invalid @endif" name="max_quota"
                                            id="max_quota" placeholder="Masukkan Kuota Keseluruhan"
                                            value="{{ old('max_quota') }}" required>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control
                                            @if($errors->has('banner')) is-invalid @endif" accept="image/*"
                                            onchange="loadFile(event)" name="banner" id="banner"
                                            value="{{ old('banner') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" id="minimum_transaction" name="minimum_transaction"
                                                class="form-control
                                                @if ($errors->has('minimum_transaction')) is-invalid @endif"
                                                placeholder="Masukkan Minimum Nominal Transaksi"
                                                value="{{ old('minimum_transaction') }}" required>
                                            @if($errors->has('minimum_transaction'))
                                            <span class="error invalid-feedback">{{
                                                $errors->first('minimum_transaction') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" id="minimum_quantity" name="minimum_quantity" class="form-control
                                                ...
                                                placeholder="Masukkan Minimum Kuantiti Pembelian"
                                                value="{{ old('minimum_quantity') }}" required>
                                            @if($errors->has('minimum_quantity'))
                                            <span class="error invalid-feedback">{{ $errors->first('minimum_quantity')
                                                }}</span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="minimum_tx_history">Minimum Nominal (History Transaksi
                                            Customer)</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Rp </span>
                                            </div>
                                            <input type="number" id="minimum_tx_history" name="minimum_tx_history"
                                                class="form-control
                                                @if ($errors->has('minimum_tx_history')) is-invalid @endif"
                                                placeholder="Nominal Transaksi Secara Akumulasi"
                                                value="{{ old('minimum_tx_history') }}" required>
                                            @if($errors->has('minimum_tx_history'))
                                            <span class="error invalid-feedback">{{ $errors->first('minimum_tx_history')
                                                }}</span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="minimum_qty_history">Minimum Kuantiti (History Transaksi
                                            Customer)</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Qty</span>
                                            </div>
                                            <input type="number" id="minimum_qty_history" name="minimum_qty_history"
                                                class="form-control
                                                @if ($errors->has('minimum_qty_history')) is-invalid @endif"
                                                placeholder="Kuantiti Pembelian Secara Akumulasi"
                                                value="{{ old('minimum_qty_history') }}" required>
                                            @if($errors->has('minimum_qty_history'))
                                            <span class="error invalid-feedback">{{
                                                $errors->first('minimum_qty_history') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" id="minimum_margin" name="minimum_margin" class="form-control
                                                ...
                                                value="{{ old('minimum_margin') }}" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-percent"></i></span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_payment_method" name="switch_payment_method" {{
                                                !empty(old('switch_payment_method')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_payment_method">Tidak /
                                                Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8 col-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker payment-method border
                                            ...
                                            id="payment_method" name="payment_method[]" data-live-search="true" multiple
                                            title="Pilih Metode Pembayaran" {{ !empty(old('payment_method')) ? ''
                                            : 'disabled' }}>
                                            @foreach ($paymentMethod as $value)
                                            <option value="{{ $value->PaymentMethodID }}" {{
                                                collect(old('payment_method'))->contains($value->PaymentMethodID) ?
                                                'selected' : '' }}>
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('payment_method')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4 pt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_distributor_location" name="switch_distributor_location" {{
                                                !empty(old('switch_distributor_location')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_distributor_location">Tidak
                                                / Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8 col-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker distributor-location border
                                            ...
                                            id="distributor_location" name="distributor_location[]"
                                            data-live-search="true" multiple title="Pilih Lokasi Distributor" {{
                                            !empty(old('distributor_location')) ? '' : 'disabled' }}>
                                            @foreach ($distributorLocation as $value)
                                            <option value="{{ $value->DistributorID }}" {{
                                                collect(old('distributor_location'))->contains($value->DistributorID) ?
                                                'selected' : '' }}>
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('distributor_location')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4 pt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_term_brand" name="switch_term_brand" {{
                                                !empty(old('switch_term_brand')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_term_brand">Tidak /
                                                Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8 col-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker term-brand border
                                                    @if($errors->has('term_brand')) is-invalid @endif" id="term_brand"
                                            name="term_brand[]" data-live-search="true" multiple title="Pilih Brand" {{
                                            !empty(old('term_brand')) ? '' : 'disabled' }}>
                                            @foreach ($termBrand as $value)
                                            <option value="{{ $value->BrandID }}" {{ collect(old('term_brand'))->
                                                contains($value->BrandID) ? 'selected' : '' }}>
                                                {{ $value->Brand }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4 pt-2">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_term_category" name="switch_term_category" {{
                                                !empty(old('switch_term_category')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_term_category">Tidak /
                                                Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8 col-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker term-category border
                                            ...
                                            id="term_category" name="term_category[]" data-live-search="true" multiple
                                            title="Pilih Kategori" {{ !empty(old('term_category')) ? '' : 'disabled' }}>
                                            @foreach ($termCategory as $value)
                                            <option value="{{ $value->ProductCategoryID }}" {{
                                                collect(old('term_category'))->contains($value->ProductCategoryID) ?
                                                'selected' : '' }}>
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('term_category')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-12 py-auto">
                                    <div class="form-group m-0 py-1 py-lg-4">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_new_user" name="switch_new_user" {{
                                ...
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control new-user
                                            ...
                                            name="start_date_new_user" id="start_date_new_user"
                                            value="{{ old('start_date_new_user') }}" {{
                                            $errors->has('start_date_new_user') || $errors->has('end_date_new_user') ||
                                        old('start_date_new_user') ? '' : 'disabled' }}>
                                        @if($errors->has('start_date_new_user'))
                                        <span class="error invalid-feedback">{{ $errors->first('start_date_new_user')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control new-user
                                            ...
                                            name="end_date_new_user" id="end_date_new_user"
                                            value="{{ old('end_date_new_user') }}" {{
                                            $errors->has('start_date_new_user') || $errors->has('end_date_new_user') ||
                                        old('end_date_new_user') ? '' : 'disabled' }}>
                                        @if($errors->has('end_date_new_user'))
                                        <span class="error invalid-feedback">{{ $errors->first('end_date_new_user')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-12 py-auto">
                                    <div class="form-group m-0 py-1 py-lg-4">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_merchant_restock" name="switch_merchant_restock" {{
                                                !empty(old('switch_merchant_restock')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_merchant_restock">Tidak /
                                                Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local"
                                            class="form-control merchant-restock
                                                    @if ($errors->has('start_date_merchant_restock')) is-invalid @endif"
                                            name="start_date_merchant_restock" id="start_date_merchant_restock"
                                            value="{{ old('start_date_merchant_restock') }}" {{
                                            $errors->has('start_date_merchant_restock') ||
                                        $errors->has('end_date_merchant_restock') || old('start_date_merchant_restock')
                                        ? '' : 'disabled' }}>
                                        @if($errors->has('start_date_merchant_restock'))
                                        <span class="error invalid-feedback">{{
                                            $errors->first('start_date_merchant_restock') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control merchant-restock
                                            ...
                                            name="end_date_merchant_restock" id="end_date_merchant_restock"
                                            value="{{ old('end_date_merchant_restock') }}" {{
                                            $errors->has('start_date_merchant_restock') ||
                                        $errors->has('end_date_merchant_restock') || old('end_date_merchant_restock') ?
                                        '' : 'disabled' }}>
                                        @if($errors->has('end_date_merchant_restock'))
                                        <span class="error invalid-feedback">{{
                                            $errors->first('end_date_merchant_restock') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-12 py-auto">
                                    <div class="form-group m-0 py-1 py-lg-4">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input form-control"
                                                id="switch_customer_tx" name="switch_customer_tx" {{
                                                !empty(old('switch_customer_tx')) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="switch_customer_tx">Tidak /
                                                Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control customer-tx
                                            ...
                                            name="start_date_customer_tx" id="start_date_customer_tx"
                                            value="{{ old('start_date_customer_tx') }}" {{
                                            $errors->has('start_date_customer_tx') ||
                                        $errors->has('end_date_customer_tx') || old('start_date_customer_tx') ? '' :
                                        'disabled' }}>
                                        @if($errors->has('start_date_customer_tx'))
                                        <span class="error invalid-feedback">{{ $errors->first('start_date_customer_tx')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-5 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control customer-tx
                                            ...
                                            name="end_date_customer_tx" id="end_date_customer_tx"
                                            value="{{ old('end_date_customer_tx') }}" {{
                                            $errors->has('start_date_customer_tx') ||
                                        $errors->has('end_date_customer_tx') || old('end_date_customer_tx') ? '' :
                                        'disabled' }}>
                                        @if($errors->has('end_date_customer_tx'))
                                        <span class="error invalid-feedback">{{ $errors->first('end_date_customer_tx')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group m-0">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input form-control"
                                        id="switch_term_product" name="switch_term_product" {{
                                        !empty(old('switch_term_product')) ? 'checked' : '' }}>
                    ...
                    <div id="term-product" class="{{ !empty(old('switch_term_product')) ? '' : 'd-none' }}">
                        <div id="add-term-product" class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <button href="" class="btn btn-sm float-right remove"><i
                                            class="far fa-times-circle fa-lg text-danger"></i></button>
                                    <select class="form-control selectpicker border select-product
                                        ...
                                        <option value="{{ $value->ProductID }}" {{ collect(old('term_product'))->
                                            contains($value->ProductID) ? 'selected' : '' }}>
                                            {{ $value->ProductName }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_tx_product">Minimum Nominal Transaksi Produk (Saat
                                        Checkout)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Rp </span>
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('minimum_tx_product')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_qty_product">Minimum Kuantiti Transaksi Produk (Saat
                                        Checkout)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Qty </span>
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('minimum_qty_product')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_tx_product_history">Minimum Nominal (History Transaksi
                                        Customer)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Rp </span>
                                        ...
                                        <span class="error invalid-feedback">{{
                                            $errors->first('minimum_tx_product_history') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_qty_product_history">Minimum Kuantiti (History Transaksi
                                        Customer)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Qty </span>
                                        </div>
                                        <input type="number" name="minimum_qty_product_history[]"
                                            class="form-control
                                        ...
                                        <span class="error invalid-feedback">{{
                                            $errors->first('minimum_qty_product_history') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_tx_product_restock">Minimum Nominal (History Restock
                                        Merchant)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Rp </span>
                                        ...
                                        <span class="error invalid-feedback">{{
                                            $errors->first('minimum_tx_product_restock') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="minimum_qty_product_restock">Minimum Kuantiti (History Restock
                                        Merchant)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Qty </span>
                                        </div>
                                        <input type="number" name="minimum_qty_product_restock[]"
                                            class="form-control
                                        ...
                                        <span class="error invalid-feedback">{{
                                            $errors->first('minimum_qty_product_restock') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="clearfix">
                            <button type="button" class="btn btn-secondary btn-sm add float-right"><i
