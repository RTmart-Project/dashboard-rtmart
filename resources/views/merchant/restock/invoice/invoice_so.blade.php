...
<body>
	<div class="invoice-box">
		<table>
					...
					<table>
						<tr>
							<td>
								...
								Nama Toko : <b> {{ ucwords($merchant->StoreName) }} </b> <br>
			...
			@if ($merchant->Type == "TACTICAL")
			<tr class="heading">
				<td colspan="4">Toko AR</td>
			</tr>
			@endif
			...
			<tr class="details">
				<td colspan="4">
					...
					@if ($merchant->Type == "TACTICAL")
					<br>
					Jatuh Tempo Pembayaran: 1 bulan
					@endif
				</td>
			</tr>
			...
			<tr class="total">
				...
				<th colspan="1" class="text-right pt">{{ Helper::formatCurrency($merchant->DiscountVoucher, 'Rp ') }}
				</th>
			</tr>
			@endif
			...
			<tr class="total">
				...
				<th colspan="1" class="text-right pt">{{ Helper::formatCurrency($merchant->ServiceChargeNett, 'Rp ') }}
				</th>
			</tr>
			@endif
