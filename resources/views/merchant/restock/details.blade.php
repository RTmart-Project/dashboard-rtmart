      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('merchant.restock') }}" class="btn btn-sm btn-light mb-2"><i
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-12">
                ...
                <h6><strong>No. Telp : </strong><a href="tel:{{ $merchant->PhoneNumber }}">{{ $merchant->PhoneNumber
                    }}</a></h6>
              </div>
              <div class="col-md-4 col-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="timeline">
                          ...
                          <div>
                            <i class="far fa-clock @if($value->StatusOrderId == " S009") bg-secondary
                    ...
                    <table class="table text-nowrap">
                      ...
                      <tfoot>
                        ...
                        <tr>
                          ...
                          <th class="py-1 px-2 border-0 text-danger">{{ Helper::formatCurrency($merchant->DiscountPrice,
                            'Rp ') }}</th>
                        </tr>
                        @endif
                        ...
                        <tr>
                          ...
                          <th class="py-1 px-2 border-0 text-danger">{{
                            Helper::formatCurrency($merchant->DiscountVoucher, 'Rp ') }}</th>
                        </tr>
                        @endif
                        ...
                        <tr>
                          ...
                          <th class="py-1 px-2 border-0">{{ Helper::formatCurrency($merchant->ServiceChargeNett, 'Rp ')
                            }}</th>
                        </tr>
                        @endif
                        ...
                        <tr>
                          ...
                          <th class="py-1 px-2 border-0">{{ Helper::formatCurrency($merchant->DeliveryFee, 'Rp ') }}
                          </th>
                        </tr>
                        @endif
                        <tr>
                          ...
                          <th class="py-1 px-2 border-0">{{ Helper::formatCurrency($subTotal - $merchant->DiscountPrice
                            - $merchant->DiscountVoucher + $merchant->ServiceChargeNett + $merchant->DeliveryFee, 'Rp ')
                            }}</th>
                        </tr>
                      </tfoot>
                    </table>
