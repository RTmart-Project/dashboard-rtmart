                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" id="price" placeholder="Masukkan Harga Default" autocomplete="off"
                                            class="form-control autonumeric @if($errors->has('price')) is-invalid @endif" required>
                                        @if($errors->has('price'))
