...
@section('title', 'Dashboard - Add Product Brand')

@section('header-menu', 'Tambah Merek Produk')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="add-brand" method="post" action="{{ route('product.insertBrand') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="nama-brand">Nama Merek </label>
                                        <input type="text" name="brand_name" class="form-control @if($errors->has('brand_name')) is-invalid @endif" id="nama-brand" placeholder="Masukkan Nama Tipe Produk" required>
