...
@section('title', 'Dashboard - Edit Product Type')

@section('header-menu', 'Ubah Tipe Produk')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type_name" value="{{ $typeById->ProductTypeName }}" class="form-control @if($errors->has('type_name')) is-invalid @endif" id="nama-tipe" placeholder="Masukkan Nama Tipe Produk" required>
