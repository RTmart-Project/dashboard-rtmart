...
@section('title', 'Dashboard - Summary Report Detail - Jumlah DO')
...
@section('header-menu', 'Summary Report Detail - Jumlah DO')
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="summary-count-do">
                <div class="row">
                  <div class="col-12">
...
<!-- Main JS -->
<script src="{{url('/')}}/main/js/summary/report/detail/do/count-do.js"></script>
