...
@section('title', 'Dashboard - Summary Report Detail - Jumlah Merchant DO')
...
@section('header-menu', 'Summary Report Detail - Jumlah Merchant DO')
        ...
        <div class="card">
              ...
              <div class="col-3">
                <div class="info-box m-0">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number h6 m-0">{{ $data }}</span>
                  </div>
                </div>
              </div>
              <div class="col-3">
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="summary-count-merchant-do">
                <div class="row">
                  <div class="col-12">
...
<!-- Main JS -->
<script src="{{url('/')}}/main/js/summary/report/detail/do/count-merchant.js"></script>
