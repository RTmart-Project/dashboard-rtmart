...
@section('title', 'Dashboard - Summary Report Detail - Jumlah PO')
...
@section('header-menu', 'Summary Report Detail - Jumlah PO')
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="summary-count-po">
                <div class="row">
                  <div class="col-12">
...
<!-- Main JS -->
<script src="{{url('/')}}/main/js/summary/report/detail/po/count-po.js"></script>
