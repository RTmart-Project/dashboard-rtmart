...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'distribution'], function () {
        ...
        Route::group(['prefix' => 'restock', 'middleware' => ['checkRoleUser:IT,AD,RBTAD,BM,CEO,FI,AH,DMO,HL,SM']], function () {
            ...
            Route::get('/edit/{stockOrderID}', [DistributionController::class, 'editRestock'])->name('distribution.editRestock')->middleware('checkRoleUser:IT');
            Route::post('/update/{stockOrderID}', [DistributionController::class, 'updateRestock'])->name('distribution.updateRestock')->middleware('checkRoleUser:IT');
    ...
    Route::group(['middleware' => ['checkRoleUser:IT,BM,CEO,FI,AH,HR,DMO,RBTAD,HL,SM,SV,AD']], function () {
        ...
        Route::get('/distributor/account/getAllDistributor', [DistributorController::class, 'getAllAccounts'])->withoutMiddleware('checkRoleUser:IT,BM,CEO,FI,AH,HR,DMO,RBTAD,SM')->name('distributor.getAccounts');
    ...
    // Merchant
    Route::group(['middleware' => ['checkRoleUser:IT,BM,CEO,FI,AH,HR,DMO,HL,RBTAD,SM,AD,SKR,CI']], function () {
    ...
    Route::group(['middleware' => ['checkRoleUser:IT,BM,CEO,FI,AH,HR,SM,SKR,CI']], function () {
    ...
    // Customer
    Route::group(['middleware' => ['checkRoleUser:IT,BM,CEO,FI,AH,HR,DMO,RBTAD,CI']], function () {
