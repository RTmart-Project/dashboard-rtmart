  ...
  public function getStocks()
  {
    $sql = DB::table('ms_stock_product_log')
      ...
      ->selectRaw("
          ...
          ANY_VALUE(ms_stock_product_log.ProductID) AS ProductID, 
          ...
          SUM(IF(ms_stock_product.ConditionStock = 'GOOD STOCK', ms_stock_product_log.QtyAction, 0)) AS GoodStock,
          SUM(IF(ms_stock_product.ConditionStock = 'GOOD STOCK', ms_stock_product_log.QtyAction * ms_stock_product_log.PurchasePrice, 0)) AS NominalGoodStock,
