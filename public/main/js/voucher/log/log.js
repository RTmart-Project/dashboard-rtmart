$(document).ready(function () {
    ...
    function dataTablesVoucherLog() {
        $("#voucher-log .table-datatables").DataTable({
            dom:
                "<'row'<'col-sm-12 col-md-5'<'filter-voucher-log'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
    ...
    $("#voucher-log .filter-voucher-log").on(
        "change",
        "#from_date",
        function () {
            dateStartChange();
