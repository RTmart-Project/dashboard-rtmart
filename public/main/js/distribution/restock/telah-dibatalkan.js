$(document).ready(function () {
    ...
    function dataTablesTelahDibatalkan() {
        $('#telah-dibatalkan .table-datatables').DataTable({
            dom: "<'row'<'col-sm-12 col-md-5'<'filter-telah-dibatalkan'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
            ...
            buttons: [{
                extend: 'excelHtml5',
                filename: function () {
                    return exportDatatableHelper.generateFilename('RestockTelahDibatalkan');
                },
    ...
    $('#telah-dibatalkan .filter-telah-dibatalkan').on('change', '#from_date', function () {
        dateStartChange();
    });
    // Disabled input from date ketika to date berubah
    $('#telah-dibatalkan .filter-telah-dibatalkan').on('change', '#to_date', function () {
        dateEndChange();
    });
    ...
    $("#telah-dibatalkan #refresh").click(function () {
        ...
        $('#telah-dibatalkan .table-datatables').DataTable().ajax.reload(null, false);
    });
