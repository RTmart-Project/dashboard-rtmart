$(document).ready(function () {
    ...
    function dataTablesPesananBaru() {
        $('#pesanan-baru .table-datatables').DataTable({
            dom: "<'row'<'col-sm-12 col-md-5'<'filter-pesanan-baru'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
            ...
            buttons: [{
                extend: 'excelHtml5',
                filename: function () {
                    return exportDatatableHelper.generateFilename('RestockPesananBaru');
                },
    ...
    $('#pesanan-baru .filter-pesanan-baru').on('change', '#from_date', function () {
        dateStartChange();
    });
    // Disabled input from date ketika to date berubah
    $('#pesanan-baru .filter-pesanan-baru').on('change', '#to_date', function () {
        dateEndChange();
    });
    ...
    $("#pesanan-baru #refresh").click(function () {
        ...
        $('#pesanan-baru .table-datatables').DataTable().ajax.reload(null, false);
    });
