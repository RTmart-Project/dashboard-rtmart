$(document).ready(function () {
    ...
    function dataTablesDalamProses() {
        $('#dalam-proses .table-datatables').DataTable({
            dom: "<'row'<'col-sm-12 col-md-5'<'filter-dalam-proses'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
            ...
            buttons: [{
                extend: 'excelHtml5',
                filename: function () {
                    return exportDatatableHelper.generateFilename('RestockDalamProses');
                },
    ...
    $('#dalam-proses .filter-dalam-proses').on('change', '#from_date', function () {
        dateStartChange();
    });
    // Disabled input from date ketika to date berubah
    $('#dalam-proses .filter-dalam-proses').on('change', '#to_date', function () {
        dateEndChange();
    });
    ...
    $("#dalam-proses #refresh").click(function () {
        ...
        $('#dalam-proses .table-datatables').DataTable().ajax.reload(null, false);
    });
