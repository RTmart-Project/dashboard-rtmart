$(document).ready(function () {
    ...
    function dataTablesDikonfirmasi() {
        $('#telah-dikonfirmasi .table-datatables').DataTable({
            dom: "<'row'<'col-sm-12 col-md-5'<'filter-telah-dikonfirmasi'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
            ...
            "ajax": {
                ...
                data: function (d) {
                    d.fromShipmentDate = $('#telah-dikonfirmasi #from_date').val();
            ...
            buttons: [{
                extend: 'excelHtml5',
                filename: function () {
                    return exportDatatableHelper.generateFilename('RestockTelahDikonfirmasi');
                },
    ...
    $('#telah-dikonfirmasi .filter-telah-dikonfirmasi').on('change', '#from_date', function () {
        dateStartChange();
    });
    // Disabled input from date ketika to date berubah
    $('#telah-dikonfirmasi .filter-telah-dikonfirmasi').on('change', '#to_date', function () {
        dateEndChange();
    });
    ...
    $("#telah-dikonfirmasi #refresh").click(function () {
        ...
        $('#telah-dikonfirmasi .table-datatables').DataTable().ajax.reload(null, false);
    });
