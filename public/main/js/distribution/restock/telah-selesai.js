$(document).ready(function () {
    ...
    function dataTablesTelahSelesai() {
        $('#telah-selesai .table-datatables').DataTable({
            dom: "<'row'<'col-sm-12 col-md-5'<'filter-telah-selesai'>tl><'col-sm-12 col-md-3'l><'col-sm-12 col-md-3'f><'col-sm-12 col-md-1'B>>" +
                "<'row'<'col-sm-12'tr>>" +
            ...
            buttons: [{
                extend: 'excelHtml5',
                filename: function () {
                    return exportDatatableHelper.generateFilename('RestockTelahSelesai');
                },
    ...
    $('#telah-selesai .filter-telah-selesai').on('change', '#from_date', function () {
        dateStartChange();
    });
    // Disabled input from date ketika to date berubah
    $('#telah-selesai .filter-telah-selesai').on('change', '#to_date', function () {
        dateEndChange();
    });
    ...
    $("#telah-selesai #refresh").click(function () {
        ...
        $('#telah-selesai .table-datatables').DataTable().ajax.reload(null, false);
    });
